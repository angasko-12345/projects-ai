...
3. Commit strategy resolved 2026-09-15: AgentOps work committed as `935f4dc` (37 files, +10283/-173); `tasks/`, `.agents/`, `.agent/` versioned in a new projects-root repo (`58355c5`, scoped via .gitignore to those three folders; nested `agentops/` repo stays independent).
